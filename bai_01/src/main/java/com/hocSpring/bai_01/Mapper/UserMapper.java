...
public interface UserMapper {
    ...
    // @Mapping(source ="firstName" ,target="lastName")// chuyen doi truong
    // firstName cua request thanh lastName cua user
    void updateUser(UserUpdateRequest request, @MappingTarget User user);// cap nhat thong tin user tu request thay the
                                                                         // cho viec set tung truong
    // @Mapping(target = "lastName", ignore = true) // bo qua truong lastName khi
    // chuyen doi
